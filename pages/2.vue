  ...
  <div class="px-4">
    ...
    <nav class="flex justify-between items-center pt-4" aria-label="Table navigation">
      ...
      <ul v-if="(Product.count > 13)" class="inline-flex items-center -space-x-px rounded-lg">
        ...
        <li>
          <a href="/3"
            class="py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 rounded-r-lg">3</a>
        </li>
      </ul>
    </nav>
  </div>
      ...
      <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class="relative w-full max-w-2xl h-full md:h-auto">
              <!-- Modal content -->
              <form @submit.prevent="update_pd" action="#" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                  <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    Editar producto
